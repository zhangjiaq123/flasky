...
class User(UserMixin,db.Model):
    ...
    def to_json(self):
        json_user = {
            ...
            'post': url_for('api.get_user_posts', id=self.aid,
                              _external=True),
            'followed_posts': url_for('api.get_followed_posts', id=self.id,
                                _external=True),
...
class Role(db.Model):
    ...
    dafault = db.Column(db.Boolean,default=False,index=True)
